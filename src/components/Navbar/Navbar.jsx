          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-[rgb(141,72,23)] bg-[rgb(220,181,153)] hover:bg-[rgb(141,72,23)] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              {navigation.map((item) => (
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? "bg-[rgb(141,72,23)] text-white"
                      : " hover:bg-[rgb(220,181,153)] text-white",
